      ...
      <div className="relative overflow-hidden bg-white">
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 py-20 sm:px-10 lg:flex-row lg:items-center">
          <div className="max-w-2xl space-y-8 text-center lg:text-left">
            <span className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-white px-4 py-1 text-sm font-medium text-brand-700 shadow-[0_10px_40px_-30px_rgba(15,23,42,0.35)]">
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center lg:justify-start">
              ...
              <Link
                href="/home"
                className="inline-flex items-center justify-center rounded-xl border border-brand-200 bg-white px-6 py-3 text-base font-semibold text-brand-700 shadow-[0_12px_40px_-32px_rgba(15,23,42,0.4)] transition hover:border-brand-300 hover:text-brand-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-200"
              >
            ...
            <div className="grid gap-4 pt-6 text-left sm:grid-cols-2">
              {[
                ...
                <div
                  key={feature.title}
                  className="flex items-start gap-3 rounded-2xl border border-brand-200 bg-white p-5 shadow-[0_18px_40px_-32px_rgba(15,23,42,0.3)]"
                >
          ...
          <div className="mx-auto w-full max-w-sm rounded-3xl border border-brand-200 bg-white p-8 text-left shadow-[0_30px_90px_-45px_rgba(15,23,42,0.35)]">
