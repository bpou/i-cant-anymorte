  ...
  return (
    <div className="min-h-screen bg-[#f7f3ee] text-slate-900">
      <main className="relative isolate overflow-hidden">
        <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu blur-3xl">
          <div className="mx-auto h-[480px] w-[720px] bg-gradient-to-br from-emerald-200/50 via-sky-200/40 to-amber-200/40 opacity-70" />
        </div>
